...
<div class="site">
  ...
  <div class="brand-grid">
    <div class="brand-box">La Roche_Posay <img src="logo/laro.png" alt="Logo La Roche_Posay"></div>
    <div class="brand-box">Unilever <img src="logo/uni.png" alt="Logo Unilever"></div>
    <div class="brand-box">FOCALLURE <img src="logo/focallure.png" alt="Logo FOCALLURE"></div>
    <div class="brand-box">L'ORÉAL <img src="logo/l'o.png" alt="Logo L'ORÉAL"></div>
    <div class="brand-box">MAYBELLINE <img src="logo/maybelline.png" alt="Logo MAYBELLINE"></div>
    <div class="brand-box">ANESSA <img src="logo/anessa.png" alt="Logo ANESSA"></div>
    <div class="brand-box">INNISFREE <img src="logo/innis.png" alt="Logo INNISFREE"></div>
    <div class="brand-box">COLGATE <img src="logo/colgate.png" alt="Logo COLGATE"></div>
    <div class="brand-box">SULWHASOO <img src="logo/sun.png" alt="Logo SULWHASOO"></div>
    <div class="brand-box">PAULA'S CHOICE <img src="logo/paula.png" alt="Logo PAULA'S CHOICE"></div>
    <div class="brand-box">P&G <img src="logo/p&g.png" alt="Logo P&G"></div>
    <div class="brand-box">PERFECT DIARY <img src="logo/perfect.png" alt="Logo PERFECT DIARY"></div>
  </div>
  ...
  <div class="layout">
    ...
    <aside class="sidebar" role="complementary" aria-label="Bộ lọc sản phẩm">
      ...
      <ul>
        <li data-category="sacdep">Sắc đẹp</li>
        <li data-category="chamsoc">Chăm sóc da mặt</li>
        <li data-category="tam">Tắm & chăm sóc cơ thể</li>
        <li data-category="trang_diem">Trang điểm</li>
        <li data-category="toc">MAYBELLINE</li>
        <li data-category="phu_kien">Dụng cụ & phụ kiện làm đẹp</li>
      </ul>
      ...
      <div class="filter-group">
        ...
        <ul>
          <li><input type="checkbox" data-filter="brand" value="FOCALLURE"> FOCALLURE</li>
          <li><input type="checkbox" data-filter="brand" value="L'Oréal Paris"> L'Oréal Paris</li>
          <li><input type="checkbox" data-filter="brand" value="Cocoon"> Cocoon</li>
          <li><input type="checkbox" data-filter="brand" value="Maybelline"> Maybelline</li>
        </ul>
      </div>
    ...
    <main>
      ...
      <section class="products" id="product-list">
        ...
        <div class="product-card" data-category="sacdep" data-ma-sp="1" data-price="750000" data-brand="FOCALLURE" data-rating="4" data-shipping="Nhanh" data-condition="Mới" data-shop-type="Shopee Mall" onclick="buyNow(1)">
          <img src="images/sắc đẹp 1.png" alt="Son môi" />
          <div class="title">Son môi</div>
        ...
        <div class="product-card" data-category="chamsoc" data-ma-sp="2" data-price="100000" data-brand="L'Oréal Paris" data-rating="5" data-shipping="Hỏa Tốc" data-condition="Mới" data-shop-type="Shop Yêu Thích" onclick="buyNow(2)">
          <img src="images/sắc đẹp 2.png" alt="Set mặt nạ" />
          <div class="title">Set mặt nạ</div>
          <div class="price">₫100.000</div>
          <button class="buy-now-btn" onclick="event.stopPropagation(); buyNow(2)">
            <i class="bi bi-cart-check"></i> Đặt mua
          </button>
        </div>
        <div class="product-card" data-category="trang_diem" data-ma-sp="3" data-price="199000" data-brand="Maybelline" data-rating="3" data-shipping="Tiết Kiệm" data-condition="Đã Sử Dụng" data-shop-type="Shopee Mall" onclick="buyNow(3)">
          <img src="images/sắc đẹp 3.png" alt="Body mist" />
          <div class="title">Body mist</div>
          <div class="price">₫199.000</div>
          <button class="buy-now-btn" onclick="event.stopPropagation(); buyNow(3)">
            <i class="bi bi-cart-check"></i> Đặt mua
          </button>
        </div>
        <div class="product-card" data-category="phu_kien" data-ma-sp="4" data-price="300000" data-brand="Cocoon" data-rating="4" data-shipping="Nhanh" data-condition="Mới" data-shop-type="Shop Yêu Thích+" onclick="buyNow(4)">
          <img src="images/sắc đẹp 4.png" alt="Phấn phủ" />
          <div class="title">Phấn phủ</div>
